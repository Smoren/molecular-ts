...
export type GravityFactorConfig = number[][][];
...
export type TypesConfig = {
  ...
  GRAVITY_FACTOR: GravityFactorConfig;
...
export type RandomTypesConfig = {
  ...
  USE_GRAVITY_FACTOR_BOUNDS: boolean;
  ...
  GRAVITY_FACTOR_BOUNDS: [number, number, number?, number?];
  ...
  GRAVITY_FACTOR_MATRIX_SYMMETRIC: boolean;
  GRAVITY_FACTOR_IGNORE_SELF_TYPE: boolean;
